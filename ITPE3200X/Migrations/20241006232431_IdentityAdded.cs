    ...
    public partial class IdentityAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FollowerUserId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    FollowedUserId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImageId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    PostId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
